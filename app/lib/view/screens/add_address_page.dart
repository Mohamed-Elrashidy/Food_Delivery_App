...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  void initState() {
    ...
    if (isLooged && Get.find<UserController>().userMOdel == null) {
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
                InkWell(
                  child: Container(
                    padding: EdgeInsets.symmetric(horizontal:Dimension.scaleWidth(20),vertical: Dimension.scaleHeight(10)),
                    decoration: BoxDecoration(color: AppColors.mainColor,
                    borderRadius:BorderRadius.circular(Dimension.scaleWidth(16))),
